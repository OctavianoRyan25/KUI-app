      ...
      <li>
        <div class="flex items-center">
          ...
          <a href="{{ route('admin.mitra.show', ['id' => $mitra->id]) }}">
            <span class="text-gray-500 ms-1 text-sm font-medium hover:text-blue-600 md:ms-2">{{ $mitra->nama_mitra }}</span>
          </a>
        </div>
      </li>
    </ul>
    ...
    <form class="bg-white w-full mx-auto mb-4 p-8 rounded-md shadow-md">
      ...
      <div class="flex flex-wrap">
        <div class="w-full mb-6 px-3 lg:w-1/2">
          ...
          <input type="text" name="nama_mitra" id="nama-mitra" value="{{ old('nama_mitra', $mitra->nama_mitra) }}" class="w-full mt-2 p-2 block border border-gray-300 rounded-md shadow sm:text-sm" disabled>
        </div>
        <div class="w-full mb-6 px-3 lg:w-1/4">
          ...
          <select name="kriteria_mitra" id="kriteria-mitra" class="w-full mt-2 p-2 block border border-gray-300 rounded-md shadow sm:text-sm" disabled>
        ...
        <div class="w-full mb-6 px-3 lg:w-1/4">
          ...
          <select name="tingkat" id="tingkat" class="w-full mt-2 p-2 block border border-gray-300 rounded-md shadow sm:text-sm" disabled>
        ...
        <div class="w-full mb-6 px-3 lg:w-1/4">
          ...
          <select name="regional" id="regional" class="w-full mt-2 p-2 block border border-gray-300 rounded-md shadow sm:text-sm" disabled>
        ...
        <div class="w-full mb-6 px-3 lg:w-1/4">
          ...
          <select name="kota" id="kota" class="w-full mt-2 p-2 block border border-gray-300 rounded-md shadow sm:text-sm" disabled>
        ...
        <div class="w-full mb-6 px-3 lg:w-1/4">
          ...
          <select name="negara" id="negara" class="w-full mt-2 p-2 block border border-gray-300 rounded-md shadow sm:text-sm" disabled>
