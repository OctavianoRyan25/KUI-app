...
<body>
    <header>
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('assets/logo-udinus.png'))) }}"
            alt="Logo UDINUS">
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('assets/unggul.png'))) }}"
            alt="Logo Unggul">
    </header>
                    ...
                    <tr>
                        ...
                        <td class="signature-container">
                            @if (($index + 1) % 2 === 1)
                                {{ $index + 1 }}
                                {{-- @if ($e->signature) --}}
                                <img src="{{ $e->signature }}" alt="{{ $e->pesertas->name }}'s signature"
                                    class="signature">
                                {{-- @endif --}}
                            @endif
                        </td>
