        ...
        <div @click.away="open = false" class="flex flex-col w-full md:w-64 text-white bg-[#003d7a] dark-mode:text-gray-200 dark-mode:bg-gray-800 flex-shrink-0" x-data="{ open: false }">
            <div class="flex-shrink-0 px-8 py-4 md:mt-10 flex flex-row items-center justify-between">
                <a href="#" class="text-lg font-semibold tracking-widest text-white uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">
                    <img src="{{ asset('assets/logo-udinus.png') }}" alt="" srcset="" class="h-10 w-10 md:h-20 md:w-20">
                </a>
            ...
            <nav :class="{'block': open, 'hidden': !open}" class="flex-grow md:block px-4 pb-4 md:pb-0 md:overflow-y-auto">
                ...
                <a class="bg-transparent text-white mt-2 py-2 px-4 block text-sm font-semibold rounded-lg hover:bg-gray-200 hover:text-gray-900 focus:bg-gray-200 focus:text-gray-900 focus:outline-none focus:shadow-outline {{ request()->is('admin/mitra*') ? 'bg-yellow-500 text-black' : '' }}" href="/admin/mitra">Kerja Sama</a>
