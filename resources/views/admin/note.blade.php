                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <div class="row justify-start">
                        <div class="col-md-12 px-3">
                            <img src="{{ asset('assets/logo-udinus.png') }}"
                                class="font-bold text-3xl text-start h-10 w-10 md:h-16 md:w-16"></img>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="flex flex-wrap mt-6">
                        <div class="mb-6 px-3 w-full lg:w-1/2">
                            <label for="event_name" class="block text-sm md:text-base font-medium text-gray-700">Nama
                                Rapat</label>
                        ...
                        <div class="mb-6 px-3 w-full lg:w-1/2">
                            <label for="tempat_rapat"
                                class="block text-sm md:text-base font-medium text-gray-700">Tempat/Media Rapat</label>
                            <input type="text" name="tempat_rapat" id="tempat_rapat"
                                class="mt-2 block w-full border border-gray-300 rounded-md shadow-sm text-sm md:text-base focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm p-2"
                                required aria-required="true" value="{{ $note->event->tempat_rapat }}" readonly
                                disabled>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-wrap mt-1">
                        <div class="mb-6 px-3 w-full">
                            <label for="hal"
                                class="block text-sm md:text-base font-medium text-gray-700">Perihal</label>
                    ...
                    <div class="mb-3 px-3 w-full">
                        <label for="content"
                            class="block text-sm md:text-base font-medium text-gray-700">Konten</label>
                            ...
                            <div class="mb-6 px-3 w-full lg:w-3/4 flex items-center">
                                ...
                                <div class="flex w-1/2 items-center gap-2">
                                    @foreach ($note->event->photos as $photo)
                                        <img src="{{ asset('storage/event_photos/' . $photo->photo_path) }}"
                                            alt="photo" class="w-1/3 rounded">
                                    @endforeach
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="flex w-1/2 items-center gap-2">
                                    @foreach ($note->event->files as $file)
                                        <a href="{{ asset('storage/event_files/' . $file->file_path) }}"
                                            class="px-4 py-2 bg-blue-500 text-white rounded-md hover:bg-blue-700 transition duration-200 inline-flex">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 me-1"
                    ...
                    <div class="mb-6 flex justify-between">
                        <div class="">
                            <p class="md:mb-6 px-3 inline-flex font-semibold text-xs md:text-base">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="md:h-6 md:w-6 h-4 w-4 me-1 text-green-500" fill="currentColor"
                            ...
                            <p class="md:mb-6 px-3 inline-flex font-semibold text-xs md:text-base">
                                <svg xmlns="http://www.w3.org/2000/svg" class="md:h-6 md:w-6 h-4 w-4 me-1 text-red-500"
                            ...
                            <p class="md:mb-6 px-3 inline-flex font-semibold text-xs md:text-base">
                                <svg xmlns="http://www.w3.org/2000/svg" class="md:h-6 md:w-6 h-4 w-4 me-1 text-blue-500"
                        ...
                        <div class="">
                            <p class="mb-6 px-3 text-center text-xs md:text-base">Semarang,
