        ...
        <form action="{{ route('admin.mitra.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="w-full mb-6 px-3 lg:w-1/4">
                    ...
                    <select name="kriteria_mitra" id="kriteria-mitra"
                        ...
                        @foreach ($jenisMitras as $jenisMitra)
                            @if (old('kriteria_mitra') == $jenisMitra->jenis_mitra)
                                <option value="{{ $jenisMitra->jenis_mitra }}" selected>{{ $jenisMitra->jenis_mitra }}</option>
                            @else
                                ...
                                <tr class="odd:bg-white even:bg-gray-300">
                                    <td class="py-2 px-3 border-[#003d7a] border-r">
                                        <input type="text" name="mitra_kontaks[{{ $i }}][nama]"
                                            id="nama" value="{{ old('mitra_kontaks.' . $i . '.nama') }}"
            ...
            <div class="flex flex-wrap">
                <div class="w-full px-3 flex justify-start sm:justify-end space-x-2">
                    ...
                    <button type="submit"
                        class="bg-[#003d7a] text-white mb-4 py-2 px-4 font-bold tracking-wider rounded-md transition duration-300 hover:bg-blue-600 hover:scale-105">Tambah</button>
                </div>
            </div>
            {{-- ! action buttons end --}}
        </form>
