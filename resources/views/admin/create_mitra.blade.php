      ...
      <li>
        <div class="flex items-center">
          ...
          <a href="{{ route('admin.mitra.create') }}">
            <span class="text-gray-500 ms-1 text-sm font-medium hover:text-blue-600 md:ms-2">Tambah Mitra</span>
          </a>
        </div>
      </li>
    </ul>
    ...
    <form action="{{ route('admin.mitra.store') }}" method="POST" enctype="multipart/form-data" class="bg-white w-full mx-auto mb-4 p-8 rounded-md shadow-md">
      ...
      <div class="flex flex-wrap">
        <div class="w-full mb-6 px-3 lg:w-1/2">
          ...
          <input type="text" name="nama_mitra" id="nama-mitra" placeholder="..." value="{{ old('nama_mitra') }}" class="w-full mt-2 p-2 block border border-gray-300 rounded-md shadow focus:outline-[#003d7a] sm:text-sm" autofocus>
          @error('nama_mitra')
        ...
        <div class="w-full mb-6 px-3 lg:w-1/4">
          ...
          <select name="kriteria_mitra" id="kriteria-mitra" class="w-full mt-2 p-2 block border border-gray-300 rounded-md shadow focus:outline-[#003d7a] sm:text-sm">
            ...
            @foreach ($kriterias as $kriteria)
              @if (old('kriteria_mitra') == $kriteria)
        ...
        <div class="w-full mb-6 px-3 lg:w-1/4">
          ...
          <div class="container-preview bg-[#003d7a] w-40 h-40 mt-2 flex justify-center items-center rounded-md">
            <img class="img-preview rounded-md">
