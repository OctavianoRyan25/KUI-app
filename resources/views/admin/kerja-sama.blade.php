    ...
    <main class="container w-full mx-auto py-8 px-4">
        ...
        <div class="flex flex-wrap justify-start gap-x-[1%] gap-y-4">
            <a href="{{ route('admin.mitra.index') }}"
                class="bg-white w-full h-24 p-6 flex items-center space-x-3 rounded-md shadow-md transition duration-300 group hover:bg-[#003d7a] lg:w-[19%]">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                    class="bi bi-building text-[#003d7a] group-hover:text-white" viewBox="0 0 16 16">
                    <path
            ...
            <a href="{{ route('admin.mou.index') }}"
                class="bg-white w-full h-24 p-6 flex items-center space-x-3 rounded-md shadow-md transition duration-300 group hover:bg-[#003d7a] lg:w-[19%]">
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor"
                    class="bi bi-file-text text-[#003d7a] group-hover:text-white" viewBox="0 0 16 16">
                    <path
                ...
                <h3 class="text-xl font-semibold group-hover:text-white">MoU</h3>
            </a>
        </div>
